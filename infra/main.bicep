...
@minLength(8)
@maxLength(32)
@description('Stable lab identifier generated by deploy.ps1 and stored as a Resource Group tag.')
...
var keyVaultSuffix = toLower(uniqueString(resourceGroup().id, prefix, labInstanceId))
var acrName = take(replace('${prefix}${suffix}acr', '-', ''), 50)
var lawName = '${prefix}-${suffix}-law'
var environmentName = '${prefix}-${suffix}-aca-env'
var keyVaultName = '${take(prefix, 9)}${keyVaultSuffix}kv'
